...
# RENDERING_HOST
Set-EnvFileVariable "RENDERING_HOST" -Value "rh.vraves.localhost"
...
Set-EnvFileVariable "JSS_EDITING_SECRET" -Value $jssEditingSecret -Path .\src\Project\VRaves\vraves\.env
