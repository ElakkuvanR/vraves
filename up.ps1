...
dotnet sitecore login --cm https://cm.vraves.localhost/ --auth https://id.vraves.localhost/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.vraves.localhost/sitecore/
Start-Process https://rh.vraves.localhost/
